...
if __name__ == "__main__":
    ...
    if x == 0:
        ...
        main2.app_run(option="one", account_id=22, range_days="15-31", scraping_type="instagram")
        #main2.app_run(option="one", account_id=22, range_days="0-14", scraping_type="instagram")
    elif x == 1:
        print("Скрипт запущен")
