...
class AdaptedData(BaseModel):
  hook: str = Field(
      ...,
      description=
      "Should be a multi-line string with 5 hooks separated by newlines, like:\n"
      "1. Hook1\n2. Hook2\n3. Hook3\n4. Hook4\n5. Hook5")
  content: str
  call_to_action: str
...
3. текста песни
  ...
  spez_original_instruction = f'''
#TASK
Определи, классифицируй и оцени текстовую транскрипцию из видео файла(Instagram reels, tik tok or Youtube shorts), следуя структурированным шагам.
...
## Шаг 2
- Если переменная transcription содержит полноценный сценарий для видео, раздели текст на части: `hook`, `content`, `cta`.
  - `hook`- Первая часть текста с самой цепляющей и смысловой нагрузкой. Состоит более чем из 5 слов.
...
#Твоя задача:
##Шаг1
Придумай 5 хук для этого видео на основе TRANSCRIPTION(hook_original, content_original и call-to-action_original) и примеров вирусных Hook. Если hook_original = "-", то hook = '-'
  1. hook1: просто переведи hook_original на {language} язык.
  2. hook2: Сделай на основе примеров лучших хуков и смысла TRANSCRIPTION, которые описаны ниже. Выбери подходящий. На {language} язык. 
  3. hook3: Сделай на основе примеров лучших хуков, которые описаны ниже и смысла TRANSCRIPTION. Выбери подходящий. На {language} язык.
  4. hook4: Сделай на основе примеров лучших хуков, которые описаны ниже и смысла TRANSCRIPTION. Выбери подходящий. На {language} язык.
  5. hook5: Сделай на основе примеров лучших хуков, которые описаны ниже и смысла TRANSCRIPTION. Выбери подходящий. На {language} язык.
...
###Примеры лучших хуков на английском:
  1. You will never go viral if you don't understand this.
  2. You will never ever become a good salesman unless you do this
  3. Here are three exercises you must include in your workout as a beginner.
  4. Next time you do X and you want...
  5. This is how to (industry-related thing)...
  6. You need to stop (common industry related task)!
  7. This strategy helped me get X in X days, here is...
  8. Here is a (industry) hack that most people don’t know...
  9. Why (popular industry belief) is complete BS...
  10. What should you do if you want to (industry-related result)...
  11. (common industry mistake) is destroying your...
  12. I have done 291,200 (task) in the last decade here is...
  13. The oldest lady to ever lived drank and smoked cigarettes...
  14. X is overrated, here’s how to actually get...
  15. You're throwing (dream results) under the bus if you...
  16. I went from X to X in X (days/months/years), here is...
  17. Unethical ways to get (dream result)...
  18. Here is how to double, triple, or even 10X your...
  19. I took my client from X to X in X (days/months/years)...
  20. Here are 5 common myths popular (niche) influencers...
  21. I am going to show you how to hack the X in 30 seconds...
  22. X is dead, stop focusing on it for (desired result)...
  23. Steal my strategy to get (ideal customers dream result)...
  24. I made 10 times more X when I put all my effort...
  25. The top .1% of (avatar) do this...
  26. Stop making this (common mistake), it will just give your...
  27. The greatest X of our generation said...
  28. Here’s how to get your (desired result) in X steps...
  29. This is YOUR SIGN to finally start X...
  30. Take it from someone who has been in the industry...
  31. Doing (industry myth) is like taking relationship advice...
  32. I studied the top 10 (avatar) of the last decade and here...
  32. You would see better results (ridiculous way to see results)...
  33. I have worked with over X clients, you can practically...
  34. (industry myth) is about as true as Santa Claus...
  35. If you only have X hours per week to achieve...
  36. Making this (industry) mistake is the equivalent to...
  37. You take advice from a doctor when you're sick...
...
##Шаг4
  Переведи caption_original на {language} язык. Это будет caption_translated
