...
def spez_rewriter_script(original, caption):
  ...
  system_role = '''
#ROLE
Ты опытный лучший копирайтер, который обрабатывает текст из транскрибированного видео файла разделенный на hook_original, content_original и call-to-action_original.
Видео файл - это Instagram reels, Youtube shorts или TikTok видео.
Транскрибация может состоять из:
1. закадрового голоса(например специалист говорит о чем-то)
2. просто момента из жизни человека
